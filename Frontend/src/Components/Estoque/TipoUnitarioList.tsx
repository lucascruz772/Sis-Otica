...
const tiposUnitariosMock = Array.from({ length: 50 }, (_, i) => ({ pk: i + 1, nome: `Tipo Unitário ${i + 1}` }));
            ...
            <div className="w-full min-w-0 px-2 sm:px-4 md:px-8 flex flex-col flex-1 items-start">
                <div className="w-full flex flex-col flex-1 md:pr-8 md:pl-2 xl:pr-16 xl:pl-6 items-start">
                    ...
                    <div className="w-full flex items-center mb-2">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 text-left">Tipos Unitários</h2>
                    </div>
                    ...
                    <style>{`
                        #tiposunitarios-scroll::-webkit-scrollbar { display: none !important; }
                        #tiposunitarios-scroll { -ms-overflow-style: none !important; scrollbar-width: none !important; }
                    `}</style>
                    <div
                        id="tiposunitarios-scroll"
                        ...
                        <table className="min-w-full w-full text-xs sm:text-sm text-left text-gray-900 dark:text-white">
                            ...
                            <tbody>
                                {tiposFiltrados.length === 0 && (
                                    <tr><td colSpan={3} className="px-2 sm:px-4 py-8 text-center text-gray-500 dark:text-gray-400 text-xs sm:text-sm">Nenhum tipo unitário cadastrado.</td></tr>
                                )}
                                {tiposFiltrados.map((tipo) => (
                                    <tr key={tipo.pk} className="hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                        <td className="px-2 sm:px-4 py-2">{tipo.pk}</td>
